...
public class pila {
    ...
    public void buscarFechav(String fechaS){
        ...
        while(i<pila.size()){
            buscar = (producto) pila.get(i);
            if(buscar.fechaV.equals(fechaS)){
    ...
    public void buscarprecio(float precio){
        ...
        while(i<pila.size()){
            ...
            if(buscar.precio == precio){
                JOptionPane.showMessageDialog(null, "El producto con el precio introducido es:\n"
                                                    + "ID: " + buscar.id + "\n"
                                                    + "Nombre: " + buscar.nom + "\n"
                                                    + "Fecha lote: " + buscar.fechaS + "\n"
                                                    + "Fecha vencimiento: " + buscar.fechaV + "\n"
    ...
    public void menoralpromedio(){
        ...
        for(producto menor : pila){
            if(menor.precio < promedio){
                JOptionPane.showMessageDialog(null, "Los productos con el precio menor al promedio son:\n"
                                                    + "ID: " + menor.id + "\n"
                                                    + "Nombre: " + menor.nom + "\n"
                                                    + "Fecha lote: " + menor.fechaS + "\n"
    ...
    public void mayoralpromedio(){
        ...
        for(producto mayor : pila){
            if(mayor.precio > promedio){
                JOptionPane.showMessageDialog(null, "Los productos con el precio mayor al promedio son:\n"
                                                    + "ID: " + mayor.id + "\n"
                                                    + "Nombre: " + mayor.nom + "\n"
                                                    + "Fecha lote: " + mayor.fechaS + "\n"
    ...
    public void menorprecio(){
        ...
        for (producto men : pila){
            if(men.precio == mayor.precio){
                JOptionPane.showMessageDialog(null, "Los productos con menor precio son:\n"
                                                    + "ID: " + men.id + "\n"
                                                    + "Nombre: " + men.nom + "\n"
                                                    + "Fecha lote: " + men.fechaS + "\n"
